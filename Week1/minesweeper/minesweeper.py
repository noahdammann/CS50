...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence(cells=cells_around, count=count)
        self.knowledge.append(new_sentence)

        for _ in range(100):

            # 4) Mark additional cells as mines or safes
            safe_cells = set()
            mine_cells = set()
            ...
            # 5) Infer new sentences and add them to KB
            for sentence_1 in self.knowledge:
                for sentence_2 in self.knowledge:

                    cells_1 = sentence_1.cells
                    cells_2 = sentence_2.cells
                    count_1 = sentence_1.count
                    count_2 = sentence_2.count

                    if cells_1.issubset(cells_2) and cells_1 != cells_2:
                        new_cells = cells_2 - cells_1
                        new_count = count_2 - count_1
